        ...
        <div className="grid lg:grid-cols-[minmax(0,1fr)_minmax(0,1.1fr)] gap-16 items-start">
          ...
          <div className="lg:sticky lg:top-28">
            ...
            <p className="text-[16px] text-white/65 leading-relaxed mb-8 max-w-md">
              ...
              Skills shape reasoning; Tools execute actions. AEGIS wraps the
            ...
            <div className="rounded-2xl border border-teal-500/25 bg-teal-500/[0.07] p-5">
              <div className="flex items-center gap-3 mb-3">
                <span className="w-9 h-9 rounded-xl bg-teal-500/20 border border-teal-500/30 grid place-items-center">
                  <ShieldCheck size={16} className="text-teal-400" />
                </span>
                <div>
                  <div className="text-[13px] font-bold text-white">AEGIS Governance</div>
          ...
          <div>
            {/* AEGIS wrapper border */}
            <div className="relative rounded-2xl border border-teal-500/30 bg-teal-500/[0.03] p-6">
              {/* AEGIS label */}
              ...
              {/* Runtime status bar */}
              <div className="mb-5 flex items-center justify-between rounded-lg border border-white/10 bg-black/30 px-3 py-2">
                <div className="flex items-center gap-3">
                  <span className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse-soft" />
                  <span className="text-[11px] font-semibold text-white/70">Runtime · Production</span>
                </div>
                <div className="flex items-center gap-4 text-[10.5px] font-mono text-white/45">
              ...
              <div className="mb-5 rounded-xl border border-white/10 bg-black/30 p-4">
                ...
                <svg viewBox="0 0 480 80" className="w-full" style={{ height: 80 }}>
                  <defs>
